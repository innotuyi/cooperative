            ...
            <div class="text-left w-30 ">
                <div class="card mb-4">
                    <div class="card-header py-3">
                        <h6 class="text-uppercase">Add Share</h>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class=" col">
                                    <div class="col">
                                        ...
                                        <div class="form-outline">
                                            <label class="form-label mt-2" for="form11Example1">Joining Date</label>
                                            <input type="date" placeholder="Enter phone" class="form-control" name="phone"
                                                id="" required>
                                        </div>
